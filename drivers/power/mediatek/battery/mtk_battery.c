...
void battery_update_psd(struct battery_data *bat_data)
{
	...
	msleep(50); //prize-chj-20190619 Not booting in eng version
#endif
...
//prize-Solving NTC temperature error of battery with 3 degrees-pengzhipeng-20190627-start
#if defined (CONFIG_PROJECT_KOOBEE_K6305) || defined (CONFIG_PROJECT_KOOBEE_P7H) || defined (CONFIG_PROJECT_KOOBEE_K6303)
	return bat_temperature_val - 3;
#else
	return bat_temperature_val;
#endif 
//prize-Solving NTC temperature error of battery with 3 degrees-pengzhipeng-20190627-end
#endif
}
...
{
#if defined(CONFIG_MTK_BQ24296_SUPPORT)||defined(CONFIG_CHARGER_HL7005)||defined(CONFIG_MT6370_PMU_CHARGER) \
	|| defined(CONFIG_OZ115_SUPPORT) || defined(CONFIG_HL7005ALL_CHARGER_SUPPORT)
 	int ret_value = 0;
