		...
		unsigned long action, void *hcpu)
{
	...
	case CPU_DOWN_PREPARE_FROZEN:
		...
		break;
        //prize-chj-20190813 Solve HWT tee fingerprint restart problem start
	...
	case CPU_ONLINE:
		...
		break;
#endif
        //prize-chj-20190813 Solve HWT tee fingerprint restart problem end
